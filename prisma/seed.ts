...
async function main() {
  ...
  const transactions = [
    ...
    { vehicle: 0, customer: 0, date: '2024-01-15', payment: 'PAID', tax: 125.50, status: 'REGISTERED', plate: 'ABC-123', note: 'Completed registration process', ref: 'REF-2024-001' },
    ...
    { vehicle: 10, customer: 10, date: '2023-11-15', payment: 'PAID', tax: 130.00, status: 'REGISTERED', plate: 'EFG-123', note: 'Completed registration', ref: 'REF-2023-110' },
    { vehicle: 11, customer: 11, date: '2023-11-18', payment: 'PAID', tax: 185.75, status: 'REGISTERED', plate: 'HIJ-456', note: 'Luxury SUV registration', ref: 'REF-2023-113' },
    { vehicle: 12, customer: 12, date: '2023-11-22', payment: 'UNPAID', tax: 155.50, status: 'PICKED_UP', plate: 'KLM-789', note: 'Customer picked up', ref: 'REF-2023-117' },
    { vehicle: 13, customer: 13, date: '2023-11-25', payment: 'PAID', tax: 220.00, status: 'REGISTERED', plate: 'NOP-012', note: 'Electric vehicle registration', ref: 'REF-2023-120' },
    { vehicle: 14, customer: 14, date: '2023-11-28', payment: 'UNPAID', tax: 105.25, status: 'INSPECTED', plate: 'QRS-345', note: 'Inspection completed', ref: 'REF-2023-123' },
    ...
    { vehicle: 20, customer: 0, date: '2024-01-20', payment: 'UNPAID', tax: 75.50, status: null, plate: null, note: 'New transaction, no status yet', ref: 'REF-2024-020' },
    { vehicle: 21, customer: 1, date: '2024-01-21', payment: 'PAID', tax: 120.00, status: null, plate: null, note: 'Payment received, status pending', ref: 'REF-2024-021' },
    { vehicle: 22, customer: 2, date: '2024-01-22', payment: 'UNPAID', tax: 85.75, status: null, plate: null, note: 'Awaiting initial processing', ref: 'REF-2024-022' },
    
    // High-value transactions
    { vehicle: 23, customer: 3, date: '2024-01-23', payment: 'PAID', tax: 350.00, status: 'INSPECTED', plate: 'IJK-123', note: 'Luxury vehicle inspection', ref: 'REF-2024-023' },
    { vehicle: 24, customer: 4, date: '2024-01-24', payment: 'UNPAID', tax: 280.50, status: 'TRANSFER_PLATE', plate: 'LMN-456', note: 'High-value plate transfer', ref: 'REF-2024-024' }
  ]
